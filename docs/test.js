...
test('test if financial services object is ...', async function (t) {
    ...
    t.ok(result.financial_crypto_services.dentralized_finance_defi_platforms, "includes second level object")
    t.ok(result.financial_crypto_services.dentralized_finance_defi_platforms.decentralized_exchanges_DEX, "includes third level object")
    t.ok(result.financial_crypto_services.dentralized_finance_defi_platforms.decentralized_lending_and_borrowing, "includes third level object")
    t.ok(result.financial_crypto_services.dentralized_finance_defi_platforms.yield_farming_platforms, "includes third level object")
    t.ok(result.financial_crypto_services.dentralized_finance_defi_platforms.other_defi_platforms, "includes third level object")
    ...
    t.ok(result.financial_crypto_services.crypto_payment_processors.crypto2fiat_on_ramps_and_fiat2crypto_off_ramps, "includes third level object")
